...
#https://www.avito.ru/sarov/avtomobili?radius=200&p=100

#  https://www.avito.ru/{region}/avtomobili?radius={radius}&p=2

class Title_Model:
    def __init__(self, region, radius, deep):
        self.region = region
        self.radius = radius
        self.deep = deep

    def href_models(self):
        list_href_cars = []
        for i in range(1, self.deep):
            page = i
            url = f'https://www.avito.ru/{self.region}/avtomobili?radius={self.radius}&p={page}'
            headers = {
            ...
            avtos = soup.find_all('a', class_='snippet-link')
            # description = soup.find_all('div', class_ = 'specific-params specific-params_block')
            ...
            for avto in avtos:
                ...
                title = title[0]
                param['title'] = title
                list_href_cars.append(param)

        return list_href_cars



#https://www.avito.ru/sarov/avtomobili/gaz_3110_volga_2001_1853918790